...
//    public static List<User> filter(List<User> users, Predicate conditions) {
//        List<User> results = new ArrayList<>();
//        for (User user : users) {
//            if (conditions.whetherUserMeetsCriteria(user)) {
//                results.add(user);
//            }
//        }
//        return results;
...
//        boolean whetherUserMeetsCriteria(User user);
//    }
//
//    private static class whetherEvenInteger implements Judgement {
//        @Override
//        public boolean whetherUserMeetsCriteria(User user) {
//            return user.id % 2 == 0;
//        }
//    }
