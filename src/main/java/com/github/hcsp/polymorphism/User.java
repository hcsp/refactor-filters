...
//    private static class nameIsWang implements Predicate<User>{
//        @Override
//        public boolean test(User user) {
//            return user.name.startsWith("王");
//        }
//    }
//    private static class nameIsZhang implements Predicate<User>{
//        @Override
//        public boolean test(User user) {
//            return user.name.startsWith("张");
//        }
//    }
//    private static class idIsEven implements Predicate<User>{
//        @Override
//        public boolean test(User user) {
//            return user.id % 2 == 0;
//        }
//    }
    ...
    public static void main(String[] args) {
        filterWangUsers(Arrays.asList(new User(1,"wang"),new User(2,"b")));
    }

//    private interface Conditon{
