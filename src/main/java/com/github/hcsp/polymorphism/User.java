...
public class User {
    ...
    public static List<User> filterUsersBySurname(List<User> users, String surname) {
        return filter(users, user -> user.name.startsWith(surname));
    }

    // 过滤姓张的用户
    public static List<User> filterZhangUsers(List<User> users) {
        return filterUsersBySurname(users, "张");
    }

    // 过滤姓王的用户
    public static List<User> filterWangUsers(List<User> users) {
        return filterUsersBySurname(users, "王");
    }
