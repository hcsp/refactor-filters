...
//    public static class 判断用户ID是不是偶数 implements 判断条件是否成立{
//
//        @Override
//        public boolean 这个用户是否成立(User user) {
//            return user.id % 2 == 0;
//        }
//    }

//    private static class 判断用户是否姓张 implements 判断条件是否成立 {
//        @Override
//        public boolean 这个用户是否成立(User user) {
...
//    }
//
//    private static class 判断用户是否姓王 implements 判断条件是否成立 {
//        @Override
//        public boolean 这个用户是否成立(User user) {
//            return user.name.startsWith("王");
//        }
