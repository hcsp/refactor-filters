...
public class User {
    ...
    public interface 判断条件是否成立 {
         boolean 这个用户是否满足条件(User user);


    }
//    private static class 判断ID是否为偶数 implements 判断条件是否成立{
//
//        @Override
...
//        }
//    }
//    private static class 判断这个用户是否姓张 implements 判断条件是否成立{
//
//        @Override
//        public boolean 这个用户是否满足条件(User user) {
...
//        }
//    }
//    private static class 判断这个用户是否姓王 implements 判断条件是否成立 {
//        @Override
//        public boolean 这个用户是否满足条件(User user) {
...
//    }
    ...
    public static void main(String[] args) {
        ...
        filterZhangUsers(Arrays.asList(new User(1,"张无忌"),new User(2,"胡凯波")));
        filterWangUsers(Arrays.asList(new User(12,"王五"),new User(2,"胡凯杨")));
    }
    // 过滤ID为偶数的用户
