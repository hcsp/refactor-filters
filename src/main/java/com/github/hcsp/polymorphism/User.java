...
//    private static class IDIsEven implements Predicate {
//        @Override
...
//    private static class NameIsZhang implements Predicate {
//        @Override
//        public boolean condition(User user) {
...
//    private static class NameIsWang implements Predicate {
//        @Override
//        public boolean condition(User user) {
...
//        return filter(users, new IDIsEven());
