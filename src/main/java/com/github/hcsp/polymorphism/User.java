...
//    private interface Judgment {
//        boolean MeetTheCriteria(User user);
//    }

//    private static class UserIsEven implements Judgment {
//        @Override
//        public boolean MeetTheCriteria(User user) {
//            return user.id % 2 == 0;
//        }
//    }
//    private static class UserIsZhang implements Judgment{
//        @Override
//        public boolean MeetTheCriteria(User user) {
//            return user.name.startsWith("张");
//        }
//    }
//    private static class UserIsWang implements Judgment{
//        @Override
//        public boolean MeetTheCriteria(User user) {
